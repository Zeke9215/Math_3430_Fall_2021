...
matrix_a = [[1,2,1],[2,2,2],[3,3,3]]
matrix_b =[[9,5,4],[7,8,9],[3,7,7]]
column_vector_a = [1,2,1]
column_vector_b = [2,2,2]
column_vector_c = [3,3,3]
row_vector_d = [9,5,4]
row_vector_e = [7,8,9]
row_vector_f = [3,7,7]

add_column_vector_a = [[9, 10, 4],[7, 16, 9],[3, 14, 7]]
add_column_vector_b = [[18, 10, 8],[14, 16, 18],[6, 14, 14]]
add_column_vector_c = [[27, 15, 12],[21, 24, 27],[9, 21, 21]]



def vector_vector_multi(column_vector_a,row_vector_d):
    result = [0 for elements in column_vector_a]
    for index in range(len(result)):
        result[index] = column_vector_a[index] * row_vector_d[index]
    return result

def vector_vector_multi(column_vector_a,row_vector_e):
    result = [0 for elements in column_vector_a]
    for index in range(len(result)):
        result[index] = column_vector_a[index] * row_vector_e[index]
    return result

def vector_vector_multi(column_vector_a,row_vector_f):
    result = [0 for elements in column_vector_a]
    for index in range(len(result)):
        result[index] = column_vector_a[index] * row_vector_f[index]
    return result

def vector_vector_multi(column_vector_b,row_vector_d):
    result = [0 for elements in column_vector_b]
    for index in range(len(result)):
        result[index] = column_vector_b[index] * row_vector_d[index]
    return result

def vector_vector_multi(column_vector_b,row_vector_e):
    result = [0 for elements in column_vector_b]
    for index in range(len(result)):
        result[index] = column_vector_b[index] * row_vector_e[index]
    return result

def vector_vector_multi(column_vector_b,row_vector_f):
    result = [0 for elements in column_vector_b]
    for index in range(len(result)):
        result[index] = column_vector_b[index] * row_vector_f[index]
    return result

def vector_vector_multi(column_vector_c,row_vector_d):
    result = [0 for elements in column_vector_c]
    for index in range(len(result)):
        result[index] = column_vector_c[index] * row_vector_d[index]
    return result

def vector_vector_multi(column_vector_c,row_vector_e):
    result = [0 for elements in column_vector_c]
    for index in range(len(result)):
        result[index] = column_vector_c[index] * row_vector_e[index]
    return result

def vector_vector_multi(column_vector_c,row_vector_f):
    result = [0 for elements in column_vector_c]
    for index in range(len(result)):
        result[index] = column_vector_c[index] * row_vector_f[index]
    return result

def sum_components(add_column_vector_a):
    result = [add_column_vector_a]
    result[index] = add_column_vector_a
    return result



##I could not figure out how to write an algorithm that does the multiplication of the column vectors
#and the following vector addition in effiecient functions
#i had to resort to writing mostly every step my hand. apologies. 


print(vector_vector_multi(column_vector_a,row_vector_d))
print(vector_vector_multi(column_vector_a,row_vector_e))
print(vector_vector_multi(column_vector_a,row_vector_f))
print('vector addition of the first 3 column vectors is the firs column for the product matrix')
print(vector_vector_multi(column_vector_b,row_vector_d))
print(vector_vector_multi(column_vector_b,row_vector_e))
print(vector_vector_multi(column_vector_b,row_vector_f))
print(' vector addition of the next 3 column vectors is the second column of the product matrix')
print(vector_vector_multi(column_vector_c,row_vector_d))
print(vector_vector_multi(column_vector_c,row_vector_e))
print(vector_vector_multi(column_vector_c,row_vector_f))
print('these last 3 column vectors added by vector addition is the last column of the product matrix')
