...
def reflect_vector(vector_1: list)->list:
    ...
    e[0] = 1
    v = add_vectors(scalar_vector_multi(sign(vector_1[0])  * p_norm(vector_1,e), vector_1))
    return v
...
def deep_copy(matrix_1: list) -> list:
    "this funcrion takes Q from Stable Grahm schmidt"
...
def f_builder(vector_1: list) -> list:
    ...
    s = -2/(p_norm(vector_1))**2
    x = scalar_vector_multi(s,v_v_multi(vector_1,vector_1))
...
#print(f_builder([[2,3,4],[1,2,3],[1,1,1]]))
#print(Q_build(
#print(Householder
